...
- Состоит из двух независимых test-suite:
  - Suite A: проверка форм заявок (`big_landing_code.py`).
...
- Источник правды по поведению тестов: код (`big_landing_code.py`, `mobile_tariffs_tests/*`), затем документация.
